                                    ...
                                    <div class="col-md-12 d-flex ftco-animate">
                                        <div class="blog-entry align-self-stretch d-md-flex">
                                            ...
                                            <a href="{{ route('detail') }}" class="block-20"
                                                style="background-image: url('images/{{$image->image1}}');">   
                                            </a>
                                            <div class="text d-block pl-md-4">
                                                <div class="meta mb-3">
                                                    <div><a href="#">{{$item->created_at}}</a></div>
                                                    <div><a href="#">{{$item->user_name}}</a></div>
                                                    <div><a href="#" class="meta-chat"><span
                                                                class="icon-chat"></span>
                                                            3</a></div>
                                                </div>
                                                <h3 class="heading"><a href="{{ route('detail') }}">{{$item->title}}</a></h3>
                                                <p>{{$item->content}}</p>
                                                <p><a href="{{ route('detail') }}" class="btn btn-primary py-2 px-3">Read
                                                        more</a></p>
                                            </div>
                                        </div>
                                    </div>
